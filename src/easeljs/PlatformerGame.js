...
(function (window) {
    ...
    PlatformerGame.prototype.LoadThisTextLevel = function (textLevel) {
        ...
        this.level = new Level(this.platformerGameStage, this.platformerGameContentManager, textLevel, this.gameWidth, this.gameHeight, this.levelIndex, numberOfLevels);
