...
(function (window) {
    ...
    function Level(stage, contentManager, textLevel, gameWidth, gameHeight, levelNumber, numberOfLevels) {
        ...
        this.CreateAndAddRandomBackground(levelNumber);
    ...
    Level.prototype.LoadTile = function (tileType, x, y) {
        switch (tileType) {
            ...
            case 'I':
                return this.LoadEnemyTile(x, y, "MonsterI");
                break;
                
            case 'J':
                return this.LoadEnemyTile(x, y, "MonsterJ");
                break;
                
            case 'K':
                return this.LoadEnemyTile(x, y, "MonsterK");
                break;
            ...
            case 'M':
                return this.LoadEnemyTile(x, y, "MonsterM");
                break;
                
            case 'N':
                return this.LoadEnemyTile(x, y, "MonsterN");
                break;
                
            case 'O':
                return this.LoadEnemyTile(x, y, "MonsterO");
                break;
    ...
    Level.prototype.LoadNamedTile = function (name, collision, x, y) {
        switch (name) {
            ...
            case "imgInv":
                return new Tile(this.levelContentManager.imgInv, collision, x, y);
                break;    
                            
            case "imgLeg":
                return new Tile(this.levelContentManager.imgLeg, collision, x, y);
                break;   
                
            case "imgPla":
                return new Tile(this.levelContentManager.imgPla, collision, x, y);
                break;      
                              
            case "imgMis":
                return new Tile(this.levelContentManager.imgMis, collision, x, y);
                break;                      
        }
    };
    ...
    Level.prototype.LoadEnemyTile = function (x, y, name) {
        ...
        switch (name) {
            ...
            case "MonsterH":
                ...
                break;
            case "MonsterI":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterI));
                break;
            case "MonsterJ":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterJ));
                break;
            case "MonsterK":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterK));
                break;                                            
            case "MonsterL":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterL));
                break;                                  
            case "MonsterM":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterM));
                break;  
            case "MonsterN":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterN));
                break;                  
            case "MonsterO":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterO));
                break;                  
    ...
    Level.prototype.CreateAndAddRandomBackground = function (levelNumber) {

        backgroundSeqTile1 = new Bitmap(this.levelContentManager.imgBackgroundLayers[levelNumber]);
