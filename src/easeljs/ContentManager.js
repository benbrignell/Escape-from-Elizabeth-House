...
function ContentManager(stage, width, height) {
    ...
    var NUM_ELEMENTS_TO_DOWNLOAD = 19; // Doesn't count backgrounds; updated below
	...
	// Update with the number of backgrounds (1 per level)
	NUM_ELEMENTS_TO_DOWNLOAD = NUM_ELEMENTS_TO_DOWNLOAD + numberOfLevels;
    ...
    this.imgMonsterI = new Image();
    this.imgMonsterJ = new Image();    
    this.imgMonsterK = new Image();    
    this.imgMonsterL = new Image();    
    this.imgMonsterM = new Image();
    this.imgMonsterN = new Image();      
    this.imgMonsterO = new Image();                  
    ...
    this.imgInv = new Image();    
    this.imgLeg = new Image(); 
    this.imgPla = new Image();     
    this.imgMis = new Image();         
    ...
    this.StartDownload = function () {
        ...
        downloadProgress = new Text("-- %", "bold 18px Arial", "#FFF");
        ...
        SetDownloadParameters(this.imgMonsterI, "img/MonsterI.png");        
        SetDownloadParameters(this.imgMonsterJ, "img/MonsterJ.png");        
        SetDownloadParameters(this.imgMonsterK, "img/MonsterK.png");      
        SetDownloadParameters(this.imgMonsterL, "img/MonsterL.png");
        SetDownloadParameters(this.imgMonsterM, "img/MonsterM.png");      
        SetDownloadParameters(this.imgMonsterN, "img/MonsterN.png"); 
        SetDownloadParameters(this.imgMonsterO, "img/MonsterO.png");         
        ...
        SetDownloadParameters(this.imgInv, "img/Tiles/invisible.png");
        SetDownloadParameters(this.imgLeg, "img/Tiles/lego.png");        
        SetDownloadParameters(this.imgPla, "img/Tiles/plasticine.png");        
        SetDownloadParameters(this.imgMis, "img/Tiles/missing.png");                
    ...
    this.tick = function() {
        downloadProgress.text = "Checking online availabiliy " + Math.round((numElementsLoaded / NUM_ELEMENTS_TO_DOWNLOAD) * 100) + " %";
